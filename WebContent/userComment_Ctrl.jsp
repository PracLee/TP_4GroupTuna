<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   import="java.util.ArrayList, model.userInfo.UserInfoVO, model.comments.*,  model.post.*"%>
...
<%
  ...
  ////////////////////////////////////comments전달 ////////////////////////////////////
   ...
   if (action.equals("post")) {
      ...
      pageContext.forward("post_ctrl.jsp?action=post");
   ...
   // [단일 게시물---showOne] 구성 (게시물+좋아요+댓글) 
      ...
      PVO = (PostVO)request.getAttribute("singlePost");
      
      data.setC_post(PVO.getPnum());
      
      ArrayList<CommentsVO> postOne_comments = commentDAO.SelectPost(data);
